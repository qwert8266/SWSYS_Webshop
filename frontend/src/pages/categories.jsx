...
import { getCategoryBannerPath, normalizeProduct, getSaleBannerPath } from '../utils/productHelpers';
        ...
        async function loadProducts() {
            ...
            try {
                ...
                if (!ignoreResult) {
                    ...
                    setCategoryProducts(
                        (Array.isArray(productResponse) ? productResponse : []).map(normalizeProduct)
                    );
